...
public class HistoryLoader extends AsyncTaskLoader<ArrayList<GeneralShow>> {
    ...
    public HistoryLoader(Context context, String link ,String user_id){
        super(context);
    ...
    public ArrayList<GeneralShow> loadInBackground() {
        ...
        try{
            ...
            params.add(String.valueOf(MainActivity.LOADER_FOR_LOAD_HISTORY));
            params.add(link);
            params.add(user_id);
