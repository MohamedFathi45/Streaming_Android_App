...
public class MainScreenVliveLoader extends AsyncTaskLoader<ArrayList<GeneralShow>> {
    ...
    public MainScreenVliveLoader(Context context, String link,String cat ){
        super(context);
    ...
    public ArrayList<GeneralShow> loadInBackground() {
        ...
        try{
            ...
            params.add(String.valueOf(MainActivity.LOADER_FOR_LOAD_MAIN_SCREEN_VLIVE));
            params.add(link);
            params.add(cat);
