...
public class MainScreenTvShowsLoader extends AsyncTaskLoader<ArrayList<GeneralShow>> {
    ...
    public MainScreenTvShowsLoader(Context context, String link, String cat ){
        super(context);
    ...
    public ArrayList<GeneralShow> loadInBackground() {
        ...
        try{
            ...
            params.add(String.valueOf(MainActivity.LOADER_FOR_LOAD_MAIN_SCREEN_TV_SHOWS));
            params.add(link);
            params.add(cat);
