...
public class InverseListStatusLoader extends AsyncTaskLoader<BigInteger> {
    ...
    public InverseListStatusLoader(Context context, String link,String user_id , String movie_id){
        super(context);
    ...
    public BigInteger loadInBackground() {
        ...
        try{
            ...
            params.add(String.valueOf(MainActivity.LOADER_FOR_INVERSE_LIST_STATUS));
            params.add(link);
            params.add(user_id);
            params.add(movie_id);
