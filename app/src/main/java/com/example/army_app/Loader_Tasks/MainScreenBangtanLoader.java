...
public class MainScreenBangtanLoader extends AsyncTaskLoader<ArrayList<GeneralShow>> {
    ...
    public MainScreenBangtanLoader(Context context, String link ,String cat){
        super(context);
    ...
    public ArrayList<GeneralShow> loadInBackground() {
        ...
        try{
            ...
            params.add(String.valueOf(MainActivity.LOADER_FOR_LOAD_MAIN_SCREEN_BANGTANS));
            params.add(link);
            params.add(cat);
